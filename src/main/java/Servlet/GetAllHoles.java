 ...
 */
@WebServlet("/GetAllHoles")
public class GetAllHoles extends HttpServlet {
...
//        System.err.println(jsonModelName);
        ...
        for(int i = 0; i<ja.size();i++){
            ...
            JSONArray jay = ltm.getAllHoles(ja.get(i).toString());
            jsonpOut.addAll(jay);
            System.out.println("holes are: "+jsonpOut);
        }
